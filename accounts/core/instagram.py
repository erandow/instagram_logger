...
class Instagram:
    ...
    #USER_AGENT = 'Instagram 130.0.0.30.110 Android (32/12.0; 480dpi; 1080x1920; XIAOMI; M2007J20CG; PocoX3NFC; qcom)'
    #USER_AGENT = 'Instagram 27.0.0.7.97 Android (24/7.0; 380dpi; 1080x1920; OnePlus; ONEPLUS A3010; OnePlus3T; qcom; en_US)'
    #USER_AGENT = 'Instagram 200.0.0.32.95 Android (29/10; 440dpi; 1080x1920; samsung; SM-G975F; beyond2; samsungexynos9820; en_US)'
    ...
    def syncFromAdressBook4(self, contacts):
        return self.sendRequest('address_book/link/?include=extra_display_name,thumbnails',
                                "contacts=" + json.dumps(contacts))

    def retriveFromAdressBook(self, target_id):
        return self.sendRequest(f'discover/chaining/?target_id={target_id}')

    def retriveFromAdressBook2(self, target_id):
        return self.sendRequest(f'discover/chaining/?module=topical_explore&is_prefetch=true&target_id={target_id}')

    def retriveFromAdressBook3(self, target_id):
        post = {
            "phone_id": self.generateUUID(True),
        ...
        return self.sendRequest('discover/ayml/', post=post)
